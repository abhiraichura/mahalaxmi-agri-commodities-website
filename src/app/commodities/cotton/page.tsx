...
export default function CottonPage() {
  const categoryCommodities = commodities.filter(c => c.category === "cotton")
    ...
    <>
      ...
      <section className="relative pt-32 pb-20 bg-gradient-to-br from-primary/5 via-white to-accent/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <h1 className="text-4xl md:text-6xl font-bold text-text mt-4 mb-6">Cotton</h1>
            <p className="text-lg text-text-light max-w-2xl leading-relaxed">
              Raw cotton from Gujarat's premier cotton belt. We connect Indian ginners, spinners, 
              and exporters with reliable supply chains across India's largest cotton producing state.
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-20 bg-secondary">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <SectionReveal>
            <h2 className="text-3xl font-bold text-text mb-4">Cotton Export Requirements?</h2>
            <p className="text-text-light mb-8">
              We help Indian cotton exporters find reliable ginners and suppliers with consistent quality 
              for Shankar-6, MCU-5, and other premium varieties.
            </p>
            <Link
              href="/buyer-request/"
